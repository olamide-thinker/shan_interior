  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-15 h-25 md:w-20 md:h-20 p-0 bg-white scale-105 border overflow-hidden border-black shadow-md rounded-2xl focus:outline-none focus:ring-2 focus:ring-black relative"
      >
      ...
      {isOpen && (
        <div
          className="absolute z-50 bg-[#F5F5F0]  scale-125 text-[#333] w-72 sm:w-80 flex flex-col p-5 ml-4 border border-gray-300 shadow-xl bottom-16 md:bottom-16 right-8 md:right-full  rounded-xl transition-transform transform translate-x-0 translate-y-0"
          role="dialog"
